...
The following build and development dependencies, including transitive and
platform-conditional dependencies, are locked by `uv.lock`.
...
| pytest-cov | 7.1.0 | MIT | https://github.com/pytest-dev/pytest-cov |
