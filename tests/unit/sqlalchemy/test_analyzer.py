...
def test_class_body_declarative_base_namespace_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/models.py": b"""
import sqlalchemy.orm as orm
...
def test_transitive_attribute_rhs_class_body_module_alias_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/pkg/__init__.py": b"",
            "src/pkg/namespace.py": b"from sqlalchemy.orm import DeclarativeBase\n",
...
def test_module_alias_copy_used_by_class_body_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/models.py": b"""
import sqlalchemy.orm as orm
...
def test_transitive_module_attribute_alias_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/pkg/__init__.py": b"",
            "src/pkg/namespace.py": b"from sqlalchemy.orm import DeclarativeBase\n",
...
exported.DeclarativeBase = object
...
def test_class_global_chained_module_alias_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/models.py": b"""
import sqlalchemy.orm as orm
...
def test_top_level_repository_module_alias_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/bridge.py": b"from sqlalchemy.orm import DeclarativeBase\n",
            "src/models.py": b"""
import bridge
...
from bridge import DeclarativeBase
...
def test_transitive_module_object_prefix_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/pkg/__init__.py": b"",
            "src/pkg/namespace.py": b"from sqlalchemy.orm import DeclarativeBase\n",
...
exported = aliases.container.namespace
exported.DeclarativeBase = object
...
def test_postcanonical_class_global_module_alias_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/pkg/__init__.py": b"",
            "src/pkg/namespace.py": b"from sqlalchemy.orm import DeclarativeBase\n",
...
def test_class_body_attribute_carrier_persists_to_module_scope() -> None:
    result = _analyze(
        {
            "src/holder.py": b"",
            "src/models.py": b"""
...
def test_class_import_module_alias_mutation_is_unknown() -> None:
    result = _analyze(
        {
            "src/models.py": b"""
class Carrier:
    import sqlalchemy.orm as alias
...
def test_class_explicit_repository_submodule_import_mutation_is_unknown() -> None:
    result = _analyze(
        {
    ...
    result = _analyze(
        {
            "src/models.py": b"""
class Carrier:
    from sqlalchemy import orm as alias
...
def test_postcanonical_attribute_mutation_before_rebind_remains_unknown() -> None:
    result = _analyze(
        {
            "src/pkg/__init__.py": b"",
            "src/pkg/namespace.py": b"from sqlalchemy.orm import DeclarativeBase\n",
...
def test_future_attribute_carrier_does_not_retroactively_taint_mutation() -> None:
    result = _analyze(
        {
            "src/holder.py": b"",
            "src/models.py": b"""
...
def test_package_getattr_conditional_submodule_import_is_unknown() -> None:
    result = _analyze(
        {
            "src/pkg/__init__.py": b"""
class Namespace:
...
class Mutator:
    alias = namespace
    alias.DeclarativeBase = replacement
...
def test_class_method_namespace_mutation_does_not_taint_source() -> None:
    result = _analyze(
        {
            "src/models.py": b"""
import sqlalchemy.orm as orm
